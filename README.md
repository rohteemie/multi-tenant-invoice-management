...
- **Payment Method Tracking**:
  ...
  - Mobile Money
  - Other
- **Advanced Search & Filtering**: Comprehensive invoice filtering
  - Filter by status, customer name, invoice number
  - Date range filtering (start date, end date)
  - Amount range filtering (min amount, max amount)
  - Combine multiple filters for precise searches
  - See [ADVANCED_INVOICE_FILTERS.md](./ADVANCED_INVOICE_FILTERS.md) for details
...
- Filter exports by all available criteria (status, customer, date range, amount range)
