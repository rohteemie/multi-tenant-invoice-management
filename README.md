...
- **Multi-Currency Support**: Create invoices in 7 different currencies (USD, EUR, GBP, NGN, JPY, CAD, AUD) with automatic formatting
- **Tax/VAT Management**: Apply per-line-item tax rates, calculate tax breakdowns, and collect customer VAT numbers
...
- **Multi-Currency Support**: Create invoices in 7 currencies
  - USD (US Dollar) - $
  - EUR (Euro) - €
  - GBP (British Pound) - £
  - NGN (Nigerian Naira) - ₦
...
- **Tax/VAT Features**:
  ...
  - Customer VAT/Tax number collection
  - Tax-inclusive totals with clear breakdown
